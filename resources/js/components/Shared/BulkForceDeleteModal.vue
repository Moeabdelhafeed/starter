                    ...
                    <div class="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-card p-6 shadow-xl transition-all text-start">
                        ...
                        <div class="mb-4 flex items-center gap-3">
                            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/30">
                                <Trash class="h-5 w-5 text-red-700" />
                            </div>
                            <h3 class="text-lg font-semibold text-foreground">{{ t('bulk_force_delete') }}</h3>
                        </div>

                        <!-- Modal Body -->
                        <div class="mb-6">
                            <p class="text-sm text-muted-foreground">
                                {{ message || t('confirm_bulk_force_delete') }}
                            </p>
                        ...
                        <div class="flex justify-end gap-3">
                            ...
                            >
                                ...
                                {{ processing ? t('deleting') : t('force_delete') }}
                            </Button>
                        </div>
                    </div>
                </div>
