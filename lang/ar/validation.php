...
return [
    ...
    'allowed_email_domain' => 'يجب أن يكون نطاق البريد الإلكتروني أحد: :domains',
    'attributes' => [
        'address' => 'العنوان',
        ...
        'phone_number_verified_at' => 'تاريخ توثيق رقم الهاتف',
        'photo' => 'الصورة',
        'plot_id' => 'الحوض',
    ...
    'custom' => [
        'attribute_option_required' => 'يجب اختيار خيار لحقل :attribute.',
        'attribute_required' => 'حقل :attribute مطلوب.',
        'attribute_value_required' => 'يجب أن يحتوي حقل :attribute على قيمة.',
    ],
];
